...
class User implements Observer {
    ...
    public String name;
    public String email;
    public Map<String, Double> balances; // string userId -> double amount (positive = they owe you, negative = you owe them)
...
// Greedy DebtSimplifier Algorithm
...
class Group {
    ...
    public boolean canUserLeaveGroup(String userId) {
        ...
        for (Map.Entry<String, Double> balance : userBalanceSheet.entrySet()) {
            if (Math.abs(balance.getValue()) > 0.01) {
                return false; // Has outstanding balance whether to pay or to recieve
            }
        }
        return true;
    }
    ...
    public boolean addExpense(String description, double amount, String paidByUserId,
        ...
        // now below is just to print notifications and sending info to console to understand everything
    ...
    // calls simplifiedBalances map and calls the simplifyDebt method
